...
public class Converter {
  ...
  public static String zg12uni51(String input_text) {
    ...
    output_text = output_text.replaceAll("[\\u103b\\u107e\\u107f\\u1080\\u1081\\u1082\\u1083\\u1084]",
        "\u103c");
    ...
    output_text = output_text.replaceAll("(\\u103c)([\\u1000-\\u1021])((?:\\u1039[\\u1000-\\u1021])?)",
        "$2$3$1");
  ...
  public static int detector(String string) {
    ...
    //  return 0;}
      String[] zawgyi = {
          "ာ္", "်ာ", "[\\x20\\t\\r\\n\\f]" + "(ျ|ေ|[ၾ-ႄ])[က-အ]", "^(ျ|ေ|[ၾ-ႄ])[က-အ]",
          "[က-အ]္[^က-အ]", "ဥ္", "္း", "[ါ-ူေ်း](ျ|[ၾ-ႄ])[က-အ]", "ံု", "[က-အ]္ေ", "ၤ",
          "္" + "[\\x20\\t\\r\\n\\f]", "ာေ", "[ါ-ူ်း]ေ[က-အ]", "ေေ", "ုိ", "္$"
      };
      String[] uni =
          { "ှ", "ဿ", "ည်", "န်", "င်", "ေး", "ော", "်း", "ဵ", "[ၐ-ၙ]", "^([က-အ]ြ|[က-အ]ေ)" };
    for (String anUni : uni) {
      if (string.contains(anUni)) {
        return 1;
      }
    }
      return 2;
